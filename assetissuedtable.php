...
<thead>
 <th colspan="8" class="text-center"><h1>Asset Issued</h1></th> 
<tr >
 ...
 <?php
  ...
  $sql = "SELECT userasset.id,userasset.User_id,user101.name,asset_info.asset_Name,asset_info.asset_id,userasset.issued_on,userasset.returned_on,userasset.returned from user101,asset_info,userasset WHERE user101.User_id = userasset.User_id AND asset_info.asset_id = userasset.asset_id AND userasset.returned=0;";
  ...
  foreach($result as $row )
  {
       ?> 
        ...
        <td>
            <!-- <a href='delete.php?rn=User_id'> -->
            <!-- <button type="button" class="btn  bg-light text-danger ">Remove</button> -->
            <button id='return' class="btn  bg-light text-danger" onclick="returnAsset(<?php echo $row['id']?>)">Return</button>
        </td>
        </tr>        
...
function returnAsset(recId)
{
//alert('ON Click triggered : '+ recId);
var formData = {
recordId: recId
};
